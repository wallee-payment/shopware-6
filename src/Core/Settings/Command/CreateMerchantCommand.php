 ...
 */
#[AsCommand(name: 'wallee:settings:create-merchant')]
class CreateMerchantCommand extends Command {
	...
	{
		$output->writeln('Creating WalleePayment merchant with custom role...');
		...
		$roleId = $this->getOrCreateRoleId('Wallee viewer', $context);
		...
		if (!$roleId) {
			...
			$this->userRoleRepository->create([
				[
					...
					'privileges' => [
						'wallee.viewer',
						'wallee_sales_channel:read',
						'wallee_sales_channel_run:read',
						'wallee_sales_channel_run_log:read',
						'language:read',
						'locale:read',
						'system_config:read'
					]
