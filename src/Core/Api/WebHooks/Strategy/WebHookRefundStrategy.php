...
class WebHookRefundStrategy extends WebHookStrategyBase implements WebhookStrategyActionsInterface {
	...
	{
		/** @var \Wallee\Sdk\Model\Refund $transaction */
	...
	/**
	 * Processes the refund callback for a Wallee transaction, updating the associated order transaction state based on the refund status.
