...
namespace WalleePayment\Core\Util\Payload\CustomFields;
...
class ProductCustomFieldAttributeService
{
    ...
    /**
     *
     * @return array<string, array<string, \Wallee\Sdk\Model\LineItemAttributeCreate>>
     *
     * @throws \WalleePayment\Core\Util\Exception\InvalidPayloadException
     */
