...
class PaymentMethodFilterService
{
    ...
    public function filterPaymentMethods(
        ...
        if (is_null($settings)) {
            return $this->removeWalleePaymentMethods($paymentMethodCollection, $salesChannelContext);
        }
     ...
     */
    private function removeWalleePaymentMethods(
        PaymentMethodCollection $paymentMethodCollection,
        SalesChannelContext $salesChannelContext
    ): PaymentMethodCollection {
        $paymentMethodIds = $this->paymentMethodUtil->getWalleePaymentMethodIds($salesChannelContext->getContext());
