...
use WalleePayment\Core\Settings\Options\Integration;
use WalleePayment\Core\Settings\Service\SettingsService;
use WalleePayment\Core\Checkout\Struct\PaymentConfigStruct;
use WalleePayment\Core\Util\LocaleCodeProvider;
...
class PaymentIntegrationService
{
    ...
    public function getConfigForTransaction(
        ...
        $walleeTransaction = $settings->getApiClient()->getTransactionService()->read(
            $settings->getSpaceId(),
            $transactionId
        );
    ...
    {
        return 'https://app-wallee.com/s/' . $spaceId . '/payment/device.js?session=' . Uuid::randomHex();
    }
}
