...
// The previous import block here listed SDK models under WalleePayment\Sdk, which is
...
class CheckoutSubscriber implements EventSubscriberInterface
{
     ...
     */
    private const POSSIBLE_METHODS_CACHE_PREFIX = 'wlen_possible_methods_';
	 ...
	 * @return void
	 */
	private function removeWalleePaymentMethodFromConfirmPage($event): void
	{
	...
	/**
	 * Updates the Wallee transaction when the payload that would be sent differs from
