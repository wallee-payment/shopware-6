...
class Migration1605701047PaymentMethodConfigurationEntity extends MigrationStep {
	...
	{
		$connection->executeStatement('ALTER TABLE `wallee_payment_method_configuration` CHANGE `payment_method_configuration_id` `payment_method_configuration_id` bigint unsigned NOT NULL AFTER `data`;');
	}
