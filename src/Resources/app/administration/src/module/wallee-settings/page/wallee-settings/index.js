    ...
    methods: {
        ...
        async onSave() {
            ...
            if (validationError === 'HEADLESS') {
                this.createNotificationError({
                    ...
                    message: this.$tc('wallee-settings.settingForm.messageHeadlessIntegrationError')
                });
                ...
                this.createNotificationError({
                    title: this.$tc('wallee-settings.settingForm.titleError'),
                    message: this.$tc('wallee-settings.settingForm.messageGlobalIframeError')
                });
                this.isLoading = false;
                return;
            }
        ...
        onSetPaymentMethodDefault() {
            ...
            this.WalleeConfigurationService.setWalleeAsSalesChannelPaymentDefault(
                ...
                this.createNotificationSuccess({
                    title: this.$tc('wallee-settings.settingForm.titleSuccess'),
                    message: this.$tc('wallee-settings.salesChannelCard.messageDefaultPaymentUpdated')
                });
            });
        },
