...
switch ($release_env) {
	case RELEASE_GIT_ENV:
		exec('composer require wallee/sdk 4.6.0 -d /var/www/html');
		$composerJsonData['require']['wallee/sdk'] = '4.6.0';
		break;
	case RELEASE_SW_ENV:
		exec('composer require wallee/sdk 4.6.0 -d /var/www/html/custom/plugins/WalleePayment');
		break;
}
